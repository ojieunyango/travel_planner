...
public class NotificationService {
    ...
    public List<NotificationDto> getUserNotifications(Long userId) {
        List<Notification> notifications = notificationRepository.findByUserUseridOrderByCreateDateDesc(userId);

        return notifications.stream().map(n -> {
            NotificationDto dto = new NotificationDto();
            dto.setNoticeId(n.getNoticeId());
            dto.setUserId(n.getUser().getUserid());
            dto.setThreadId(n.getThread() != null ? n.getThread().getThreadid() : null);
            dto.setCommentId(n.getComment() != null ? n.getComment().getCommentid() : null);
